...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_useFieldValidate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hooks/useFieldValidate */ "./src/Components/hooks/useFieldValidate.js");
/* harmony import */ var _utils_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/icons */ "./src/utils/icons.js");
/* harmony import */ var _PasswordStrengthMeter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PasswordStrengthMeter */ "./src/Components/Common/PasswordStrengthMeter.js");
/* harmony import */ var _PasswordStrengthMeterText__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./PasswordStrengthMeterText */ "./src/Components/Common/PasswordStrengthMeterText.js");
...
const InputField = ({
  ...
  const [isPassVisible, setIsPassVisible] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  const {
    isValid,
    message
  } = (0,_hooks_useFieldValidate__WEBPACK_IMPORTED_MODULE_1__.useFieldValidate)(inputValues, type, errorMessage, isRequired, password, validation);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    "data-iserror": isValid,
    className: `b-blocks-input-field-container label-position-${position} b-blocks-input-field-validation-${name}`
  }, text && isLabel && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    htmlFor: name,
    className: "b-blocks-input-field-label"
  }, text, " ", isRequired && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "b-blocks-input-field-required"
  }, "*"), " "), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "b-blocks-input-field"
  }, icon && isIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "b-blocks-input-field-icon",
    dangerouslySetInnerHTML: {
      __html: icon
    }
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    onChange: e => setInputValues(e.target.value),
    type: passVisible(type),
    name: name,
    id: name,
  ...
  }), type === 'password' && passOptions.isVisibilityIcon && (isPassVisible ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_icons__WEBPACK_IMPORTED_MODULE_2__.ImEye, {
    onClick: () => setIsPassVisible(!isPassVisible),
    className: "b-blocks-input-field-passVisibilityIcon"
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_icons__WEBPACK_IMPORTED_MODULE_2__.ImEyeBlocked, {
    onClick: () => setIsPassVisible(!isPassVisible),
    className: "b-blocks-input-field-passVisibilityIcon"
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `b-blocks-input-field-error-message b-blocks-input-field-error-${name}`
  }, message), type === 'password' && (passOptions.isStrengthMeter || passOptions.isStrengthText) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "b-blocks-input-field-passStrength-container"
  }, passOptions.isStrengthMeter && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_PasswordStrengthMeter__WEBPACK_IMPORTED_MODULE_3__["default"], {
    value: inputValues
  }), passOptions.isStrengthText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_PasswordStrengthMeterText__WEBPACK_IMPORTED_MODULE_4__["default"], {
    value: inputValues,
    validationText: passOptions.passStrengthText,
...
const PasswordStrengthMeter = ({
  ...
  const length = (0,_utils_functions__WEBPACK_IMPORTED_MODULE_1__.getPassLength)(value);
  const meterCls = () => {
    switch (length) {
      case 1:
        return 'veryWeakPass';
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "b-blocks-input-field-passStrengthMeter-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `b-blocks-input-field-passStrengthMeter ${meterCls()}`
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `b-blocks-input-field-passStrengthMeter ${length > 1 ? meterCls() : ''}`
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `b-blocks-input-field-passStrengthMeter ${length > 2 ? meterCls() : ''}`
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `b-blocks-input-field-passStrengthMeter ${length > 3 ? meterCls() : ''}`
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PasswordStrengthMeter);

/***/ }),

/***/ "./src/Components/Common/PasswordStrengthMeterText.js":
/*!************************************************************!*\
  !*** ./src/Components/Common/PasswordStrengthMeterText.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const PasswordStrengthMeterText = ({
  value,
  validationText,
  strengthText
}) => {
  ...
  return length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "b-blocks-input-field-passStrengthMeterText-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `b-blocks-input-field-passStrengthMeterText ${strengthKey[length - 1]}Pass`
  }, textObj(length - 1)));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PasswordStrengthMeterText);
...
const Style = ({
  ...
  const inputStyles = inputAttr => {
    ...
    return `
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(bg)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderBoxCSS)(border)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('box-shadow', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(shadow))}
	`;
  };
  const strengthStyles = (attr, device = 'desktop') => `
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('width', attr[device].width)}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', attr[device].height)}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('margin', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(attr[device].margin))}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('padding', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(attr[device].padding))}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderBoxCSS)(attr.border)}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(attr.radius))}
	`;
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', inputField.typo).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', label.typo).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', text.typography).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', error.text.typo).googleFontLink}
			
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(inputSl, inputField.typo).styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(labelSl, label.typo).styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(errorSl, error.text.typo).styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(strengthTextSl, text.typography).styles}

			${inputSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', colors.text)}
				${inputStyles(normal)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('padding', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(inputField.desktop.padding))}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(normal.radius.desktop))}
			}
			${inputSl}::placeholder{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', colors.placeholder)}
			}
			${inputSl}:hover{
				${inputStyles(hover)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(hover.radius.desktop))}
			}
			${inputSl}:focus{
				${inputStyles(focus)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(focus.radius.desktop))}
			}
			${labelSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', label.colors.text)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('margin', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(label.desktop.margin))}
			}
			${requiredSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', label.colors.required)}
			}
			${iconSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('left', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.field.desktop.position.x) ? icon.field.desktop.position.x + 'px' : '')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('top', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.field.desktop.position.y) ? icon.field.desktop.position.y + 'px' : '')}
			}
			${iconSl}>svg{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('fill', icon.field.color)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.field.desktop.size) ? icon.field.desktop.size + 'px' : '')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('width', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.field.desktop.size) ? icon.field.desktop.size + 'px' : '')}
			}
			${passIconSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('fill', icon.password.color)}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.password.desktop.size) ? icon.password.desktop.size + 'px' : '')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('width', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.password.desktop.size) ? icon.password.desktop.size + 'px' : '')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('right', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.password.desktop.position.x) ? icon.password.desktop.position.x + 'px' : '')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('top', (0,_bpl_tools_utils_common__WEBPACK_IMPORTED_MODULE_1__.isExist)(icon.password.desktop.position.y) ? icon.password.desktop.position.y + 'px' : '')}
			}

			${errorContainerSl}>input{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('margin', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.input.desktop.margin))}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('padding', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.input.desktop.padding))}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderBoxCSS)(error.input.desktop.border)}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.input.desktop.radius))}
			}
			
			${errorSl}{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', error.text.color)}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('margin', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.text.desktop.margin))}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('padding', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.text.desktop.padding))}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderBoxCSS)(error.text.desktop.border)}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('border-radius', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(error.text.desktop.radius))}
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(error.text.bg)}
			}

			${strengthContainerSl}{
				${strengthStyles(container, 'desktop')}
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(container.bg)}
			}

			${strengthMeterSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('gap', meter.gap)}
			}
			...
			${strengthMeterSl}>.veryWeakPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('background-color', password.strength.colors.veryWeak)}
			}
			${strengthMeterSl}>.weakPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('background-color', password.strength.colors.weak)}
			}
			${strengthMeterSl}>.mediumPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('background-color', password.strength.colors.medium)}
			}
			${strengthMeterSl}>.strongPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('background-color', password.strength.colors.strong)}
			}

			${strengthTextSl}{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('margin', (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(text.desktop.margin))}
			}

			${strengthTextSl}>.veryWeakPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', password.strength.colors.veryWeak)}
			}
			${strengthTextSl}>.weakPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', password.strength.colors.weak)}
			}
			${strengthTextSl}>.mediumPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', password.strength.colors.medium)}
			}
			${strengthTextSl}>.strongPass{
					${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('color', password.strength.colors.strong)}
			}
...
/***/ "./src/Components/hooks/useFieldValidate.js":
/*!**************************************************!*\
  !*** ./src/Components/hooks/useFieldValidate.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useFieldValidate: () => (/* binding */ useFieldValidate)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _useStrongPassValidation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./useStrongPassValidation */ "./src/Components/hooks/useStrongPassValidation.js");


const useFieldValidate = (inputValues, type, errorMessage, isRequired, passwordAttr, validation) => {
  const {
    options
  } = passwordAttr;
  const {
  ...
  const pass = (0,_useStrongPassValidation__WEBPACK_IMPORTED_MODULE_1__["default"])(inputValues, options.minLength, options.isUpperCase, options.isLowerCase, options.isNumber, options.isSpecialChar);
...
/***/ "./src/Components/hooks/useStrongPassValidation.js":
/*!*********************************************************!*\
  !*** ./src/Components/hooks/useStrongPassValidation.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (passValidation);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getPassLength: () => (/* binding */ getPassLength),
/* harmony export */   isPass: () => (/* binding */ isPass)
/* harmony export */ });
const getPassLength = password => {
  let strength = 0;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BottomIcon: () => (/* binding */ BottomIcon),
/* harmony export */   ImEye: () => (/* binding */ ImEye),
/* harmony export */   ImEyeBlocked: () => (/* binding */ ImEyeBlocked),
/* harmony export */   LeftIcon: () => (/* binding */ LeftIcon),
/* harmony export */   RightIcon: () => (/* binding */ RightIcon),
/* harmony export */   TopIcon: () => (/* binding */ TopIcon),
...
const blockIcon = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
  ...
  d: "m27 8h-5v-1a2 2 0 0 1 2-2 1 1 0 0 0 0-2 4 4 0 0 0 -3 1.36 4 4 0 0 0 -3-1.36 1 1 0 0 0 0 2 2 2 0 0 1 2 2v1h-15a3 3 0 0 0 -3 3v10a3 3 0 0 0 3 3h15v1a2 2 0 0 1 -2 2 1 1 0 1 0 0 2 4 4 0 0 0 3-1.36 4 4 0 0 0 3 1.36 1 1 0 0 0 0-2 2 2 0 0 1 -2-2v-1h5a3 3 0 0 0 3-3v-10a3 3 0 0 0 -3-3zm-22 14a1 1 0 0 1 -1-1v-10a1 1 0 0 1 1-1h15v12zm23-1a1 1 0 0 1 -1 1h-5v-12h5a1 1 0 0 1 1 1z"
}), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
  d: "m11 12h-4a1 1 0 0 0 0 2h1v5a1 1 0 0 0 2 0v-5h1a1 1 0 0 0 0-2z"
}));
const TopIcon = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
  stroke: "currentColor",
  fill: "none",
  strokeWidth: "0",
  viewBox: "0 0 15 15",
...
const BottomIcon = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
  stroke: "currentColor",
  fill: "none",
  strokeWidth: "0",
  viewBox: "0 0 15 15",
...
/* harmony import */ var _Components_Common_InputField__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/InputField */ "./src/Components/Common/InputField.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const blockNameEls = document.querySelectorAll('.wp-block-b-blocks-input-field');
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_InputField__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    })));
